<div class="card-body row">
    <div class="form-group  col-6">
        ...
        <input name="title_ar" placeholder="{{trans('posts.title_ar')}}" value="{{ old('title_ar', $data->title_ar ?? '') }}"
    ...
    <div class="form-group  col-6">
        ...
        <input name="title_en" placeholder="{{trans('posts.title_en')}}"  value="{{ old('title_en', $data->title_en ?? '') }}"
    ...
    <div class="col-lg-6  col-md-6">
        <div class="form-group ">
            ...
            <textarea  placeholder="{{trans('posts.content_ar')}}" name="content_ar" rows="10" cols="90"
    ...
    <div class="col-lg-6  col-md-6">
        <div class="form-group ">
            ...
            <textarea placeholder="{{trans('posts.content_en')}}" name="content_en" rows="10" cols="90"
