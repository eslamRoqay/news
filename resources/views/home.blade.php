...
@section('content')
        ...
        <div class="col-md-6">
            <div class="card card-custom gutter-b" style="height: 150px">
                <div class="card-body">
                    ...
                    <a class="text-muted  font-weight-bold font-size-lg mt-1">{{trans('lang.customerCount')}}</a>
                </div>
            </div>
        </div>
        <div class="col-md-6">
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <rect fill="#000000" opacity="0.3" x="5" y="20" width="15" height="2" rx="1"/>
                    ...
                    <div class="text-dark font-weight-bolder font-size-h2 mt-3">{{$data['posts']}}</div>
                    <a class="text-muted  font-weight-bold font-size-lg mt-1">{{trans('lang.postCount')}}</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-header border-0">
                    ...
                    <div class="card-toolbar">
                        <div class="dropdown dropdown-inline">
                            <a href="{{route('users')}}"
                               class="btn btn-success font-weight-bolder font-size-sm mr-3">{{trans('lang.all_users')}}</a>
                        </div>
                    </div>
                </div>
