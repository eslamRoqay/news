...
// users Route
        ...
        Route::group(['prefix' => 'posts'], function () {
            $permission = 'posts';
            Route::get('/', [PostController::class, 'index'])->name('posts')->middleware('permission:read-' . $permission);
            Route::get('show/{id}', [PostController::class, 'show'])->name('posts.show')->middleware('permission:create-' . $permission);
            Route::get('create', [PostController::class, 'create'])->name('posts.create')->middleware('permission:create-' . $permission);
            Route::post('store', [PostController::class, 'store'])->name('posts.store')->middleware('permission:create-' . $permission);
            Route::get('edit/{id}', [PostController::class, 'edit'])->name('posts.edit')->middleware('permission:update-' . $permission);
            Route::post('update/{id}', [PostController::class, 'update'])->name('posts.update')->middleware('permission:update-' . $permission);
            Route::post('deletes', [PostController::class, 'deletes'])->name('posts.deletes')->middleware('permission:delete-' . $permission);
            Route::get('delete/{id}', [PostController::class, 'delete'])->name('posts.delete')->middleware('permission:delete-' . $permission);
        });
        //settings
